...
URL = "https://vpl.bibliocommons.com/v2/events"
try:
    browser = webdriver.Chrome(service=Service(DRIVER_PATH))
    browser.get(URL)
    time.sleep(3) #give time to load the content
...
#https://www.w3schools.com/css/css_combinators.asp useful for data mining CSS